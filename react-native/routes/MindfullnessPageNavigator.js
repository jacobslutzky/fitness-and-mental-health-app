...
import MindfulnessHome from '../screens/mindfulness/MindfulnessHome'
import VideoOverview from '../screens/mindfulness/VideoOverview'
import { Ionicons } from '@expo/vector-icons';
import VideoPlay from '../screens/mindfulness/VideoPlay';

const Stack = createStackNavigator();

export default function MindfulnessPageNavigator({route, navigation}) {
        ...
        return (
            ...
            <Stack.Screen name = "MindfulnessHome" component={MindfulnessHome} />
            <Stack.Screen name = "VideoOverview" component={VideoOverview} options={{title: "", 
